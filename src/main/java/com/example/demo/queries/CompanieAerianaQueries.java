...
public class CompanieAerianaQueries {
    ...
    public static final String SELECT_COMPANIEID_BY_NAME = "SELECT companieID FROM tblcompanie WHERE numeCompanie = ?";
    public static final String SELECT_COMPANIE_BY_ID = "SELECT companieID, numeCompanie FROM tblcompanie WHERE companieID = ?";
    public static final String DELETE_COMPANIE_BY_ID = "DELETE FROM tblcompanie WHERE companieID = ?";
}